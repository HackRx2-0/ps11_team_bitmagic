...
<button id="end" type="button" class="btn btn-danger" style="color: white; text-decoration: none"><a href="dashboard.php">End</a></button>
...
<script>
    ...
    button.addEventListener('click', () => {
        ...
        api = new JitsiMeetExternalAPI(domain, options);
                ...
                <!-- <iframe src="video.php" style="height: 550px; width: 100%; border:none"></iframe> -->
                </div>
                </div>
              </div>
            </div>
